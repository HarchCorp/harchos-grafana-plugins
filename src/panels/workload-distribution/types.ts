...
export const COLOR_PALETTES: Record<WorkloadColorScheme, string[]> = {
  [WorkloadColorScheme.Default]: [
    '#73BF69', '#FF9830', '#5794F2', '#F2495C', '#A352CC',
    '#FFB347', '#8AB8FF', '#FF6B6B', '#C0564F', '#7C3AED',
  ],
  [WorkloadColorScheme.Warm]: [
    '#FF6B6B', '#FF9830', '#FFB347', '#F2495C', '#C0564F',
    '#E02F44', '#FF7B54', '#FF9A76', '#FFD56F', '#FF4757',
  ],
  [WorkloadColorScheme.Cool]: [
    '#5794F2', '#8AB8FF', '#73BF69', '#A352CC', '#7C3AED',
    '#3B82F6', '#06B6D4', '#10B981', '#6366F1', '#0EA5E9',
  ],
  [WorkloadColorScheme.HarchOS]: [
    '#00D68F', '#0095FF', '#FFAA00', '#FF3D71', '#00E096',
    '#3366FF', '#FFB347', '#E02F44', '#73BF69', '#5794F2',
  ],
};
